...
samtools sort -O bam -t 16 -o ${out}/${i}.sorted.bam ${in}/${i}_bwa.bam >> ${out}/sortSD.out 2>&1
...
do
# after getting bwa.bam, sort bam
samtools sort -O bam -t 16 -o ${out}/${i}.sorted.bam ${in}/${i}_bwa.bam >> ${out}/sort31cPD.out 2>&1
